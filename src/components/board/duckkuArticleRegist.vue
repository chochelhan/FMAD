<template>
    <div>
        ...
        <div class="form-box">
            <div class="stitle"><span>{{boardName}}</span></div>
            ...
            <form novalidate @submit.prevent="validate">
                ...
                <div class="sub-title">개인정보 처리방침</div>
                <ul class="private-header-box" >
                    <li>수집하는 항목</li>
                    <li>수집 및 이용목적</li>
                    <li>보유 및 이용기간</li>
                </ul>
