...
<script>
	...
	import {
		HOST,
		API_URL_METABUS_ITEM_ADMIN_PRESENT_LIST,

	} from '../../../api/urls';
	import apiService from '../../../api/apiService'

	export default {
		name: 'metabusPresentList',
		components: {
			paganation
		},
		watch: {
		...
		methods: {
			...
			getServerData(cmd) {
				...
				apiService.post(API_URL_METABUS_ITEM_ADMIN_PRESENT_LIST, frm, (res) => {
					this.progress = false;
					let categorys = res.categoryInfo;
