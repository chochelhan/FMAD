<template>
    <div :class="'mypage-container '+mobileClass">
        ...
        <div class="contents">
            <div class="from-box">
                <div class="stitle"><span class="line">간단퀴즈 내역</span></div>
...
<script>
	...
	import {
		API_URL_BROADCAST_LIVE_QUIZ_AFTER_LIST,
		API_URL_BROADCAST_LIVE_QUIZ_AFTER_DELETE,
	} from '../../../../api/urls';
	...
	export default {
		...
		methods: {
			getData() {
				...
				apiService.post(API_URL_BROADCAST_LIVE_QUIZ_AFTER_LIST, frm, (ret) => {
			...
			getDataInfo(no) {
				...
				this.$router.push('/'+path[1]+'/'+this.no+'/afterQuizView/'+no);
			},
			deleteData(no,idx) {
				let message = {
					type:'confirm',
			...
			itemDelete(no,idx) {
				...
				apiService.post(API_URL_BROADCAST_LIVE_QUIZ_AFTER_DELETE, frm, (res) => {
